// Generated by Wrangler by running `wrangler types` (hash: 0e451c119dbaf7a5251471469c4ae895)
// Runtime types generated with workerd@1.20250321.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PACKAGE_NAME: "com.jarylchng.examplecfworkerapp";
		API_KEY: "USE SECRETS TO STORE SENSITIVE DATA";
		HANDLER: DurableObjectNamespace<import("./src/index").Handler>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PACKAGE_NAME" | "API_KEY">> {}
}
